...
\begin{definition}[Stable Lévy density]\label{def:stable_density}
...
\begin{definition}[Poisson recurrence]\label{lem:poisson_recurrence}
...
\begin{definition}[Concrete stable jump count]\label{def:concrete_jump}
...
\begin{definition}[Truncated stable measure]\label{def:trunc_measure}
...
\begin{definition}[Lévy--Itô decomposition]\label{def:levy_ito}
...
\begin{definition}[Poisson inner product]\label{def:poisson_inner}
\lean{poisson_inner}
\leanok
$\langle f, g \rangle_r = \sum_n f(n) g(n) P_r(n)$.
\end{definition}

\begin{definition}[Centered Poisson variable]\label{def:poisson_chi}
\lean{poisson_chi}
\leanok
$\chi(n) = n - r$.
\end{definition}
...
\begin{definition}[Compound Poisson path]\label{def:cp_path}
...
\begin{definition}[Banach energy space]\label{def:banach_space}
...
\begin{definition}[Distributional symmetry]\label{def:dist_sym}
...
\begin{definition}[Stable noise data]\label{def:stable_noise}
